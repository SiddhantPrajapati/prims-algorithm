//Prims algorithm
    ...
    /* create minimum_key() method for finding the vertex that
    has minimum key-value and that is not added in MST yet */
    ...
    void prim(int g[10][10],int vertices)
    {
    ...
    int main()
    {
        int vertices, g[10][10];
        printf("Enter no. of element:");
        scanf("%d",&vertices);
        printf("Enter graph in metrix form\n");
